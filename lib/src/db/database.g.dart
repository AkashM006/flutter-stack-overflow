...
class Todo extends DataClass implements Insertable<Todo> {
  ...
  const Todo({required this.id, required this.title, required this.content});
  @override
  ...
  Todo copyWith({int? id, String? title, String? content}) => Todo(
        id: id ?? this.id,
...
class $TodosTableManager extends RootTableManager<
    _$AppDatabase,
    Todos,
    Todo,
    $TodosFilterComposer,
...
typedef $TodosProcessedTableManager = ProcessedTableManager<
    _$AppDatabase,
    Todos,
    Todo,
    $TodosFilterComposer,
